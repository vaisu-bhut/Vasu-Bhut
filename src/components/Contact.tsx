...
const Contact = () => {
  ...
  return (
    <section id="contact" className="page-section bg-gradient-to-b from-background to-muted/20 relative">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:bhut.v@northeastern.edu" className="text-muted-foreground hover:text-primary transition-colors">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:6177771024" className="text-muted-foreground hover:text-primary transition-colors">
                    +1 (617) 777-1024
                  </a>
                </div>
              </div>
