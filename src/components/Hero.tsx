  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      elements.forEach((el) => {
        ...
        element.style.transform = `translate3d(${offsetX * 30}px, ${offsetY * 30}px, 0)`;
      });
    };
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
          <div className="md:w-3/5 animate-fade-in">
            <div className="mb-3 flex flex-wrap gap-2">
              ...
              <span className="inline-block py-1 px-3 rounded-full text-xs font-medium bg-secondary/10 text-secondary animate-pulse-slow" style={{ animationDelay: "1s" }}>
                Data Scientist
              </span>
            </div>
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-xl parallax-element" data-speed="0.5">
              A passionate full-stack developer with a master's degree in Information Systems
              from Northeastern University. Specializing in creating responsive web
              applications with modern technologies.
            </p>
            
            <div className="flex gap-4 items-center mb-8">
              <a 
                href="https://github.com/bhut-vasu" 
                target="_blank" 
          ...
          <div className="md:w-2/5 flex justify-center parallax-element" data-speed="-0.8">
            <AnimatedCube className="w-52 h-52 md:w-72 md:h-72 levitate" />
          </div>
        </div>
